...
$string['jupytername_help'] = 'Name dieser Notebook Aktivität';
$string['autograded_checkbox'] = 'Ist dieses Notebook automatisch benotet';
$string['autograded_checkbox_help'] = 'Aktiviere wenn dieses Notebook automatisch benotet werden soll. Dies kann später <b>nicht</b> geändert werden.';
...
$string['jupyterhub_api_url'] = 'JupyterHub API URL';
$string['jupyterhub_api_url_desc'] = 'Fügen Sie hier die URL Ihrer JupyterHub API ein.<br>Muss eine gültige URL sein (z. B. https://yourjupyterhub.com).<b>Bei Docker Container z.B. http://yourjupyterhubcontainername:port.';
$string['gradeservice_api_url'] = 'Gradeservice API URL';
$string['gradeservice_api_url_desc'] = 'Fügen Sie hier die URL der Gradeservice-API ein.';
