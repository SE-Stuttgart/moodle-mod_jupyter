...
$string['jupytername_help'] = 'Name of the activity module instance';
$string['autograded_checkbox'] = 'Is this Notebook autograded';
$string['autograded_checkbox_help'] = 'Check if this Notebook has the autograded feature enabled. This can <b>not</b> be changed later.';
...
$string['jupyterhub_api_url_desc'] = 'Add the URL of your JupyterHub API here.<br>Must be a valid URL (e.g. https://yourjupyterhub.com).<br> For Docker container e.g. http://yourjupyterhubdockercontainername:port.';
$string['gradeservice_api_url'] = 'Gradeservice API URL';
$string['gradeservice_api_url_desc'] = 'Add the URL of your JupyterHub here.';
